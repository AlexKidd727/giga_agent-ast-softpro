...
# Черный список опасных программ, которые нужно блокировать
DANGEROUS_PROGRAMS = {
    # Редакторы реестра и системные утилиты
    'regedit', 'registry', 'реестр', 'regedit.exe',
    'msconfig', 'msconfig.exe',
    # Утилиты форматирования и работы с дисками
    'format', 'format.exe', 'format.com',
    'fdisk', 'fdisk.exe',
    'diskpart', 'diskpart.exe',
    'diskpart32', 'diskpart32.exe',
    # Опасные системные утилиты
    'del', 'del.exe', 'erase', 'erase.exe',
    'rd', 'rmdir', 'rmdir.exe',
    'chkdsk', 'chkdsk.exe',  # Может быть опасным при неправильном использовании
    'sfc', 'sfc.exe',
    'bcdedit', 'bcdedit.exe',
    'bootrec', 'bootrec.exe',
    # Сетевые утилиты, которые могут быть опасны
    'netsh', 'netsh.exe',
    # Другие опасные утилиты
    'attrib', 'attrib.exe',
    'cacls', 'cacls.exe', 'icacls', 'icacls.exe',
    'takeown', 'takeown.exe',
    'subst', 'subst.exe',
    'mountvol', 'mountvol.exe'
}
