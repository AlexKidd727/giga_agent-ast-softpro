...
const Message: React.FC<MessageProps> = ({
  ...
  useEffect(() => {
    ...
    if (message.additional_kwargs["rendered"]) {
      ...
      let fullContent = message.content as string;
      
      // Если есть reasoning_content и его еще нет в content, добавляем его
      if (reasoningContent && reasoningContent.trim() && !fullContent.includes("<thinking>")) {
