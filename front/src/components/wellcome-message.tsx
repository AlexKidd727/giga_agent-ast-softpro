    ...
    <div className="flex min-h-[60vh] pt-30 max-[900px]:pt-10 w-full items-center justify-center">
      ...
      >
        ...
        <motion.p
          ...
          variants={itemVariants}
        >
          Я альтернативная версия GigaAgent с добавленными 
          возможностями личного помощника, универсальный агент 
          с открытым исходным кодом для пользователей,
          разработчиков и бизнеса.<br></br>
          Я могу планировать и решать широкий
          спектр задач: искать информацию, анализировать ее, озвучивать тексты, 
          генерировать претентации и картинки, проверять погоду,
          создавать бизнес-планы, формировать подкасты.<br></br>
          Дополнительно могу помочь с личными и рабочими делами: 
          календарем, почтой, инвестициями, разработкой приложений и сайтов.
        </motion.p>
      </motion.div>
    </div>
  );
