          ...
          <div className="space-y-6">
            ...
            <section className="space-y-3">
              ...
              <div className="text-xs text-muted-foreground bg-muted/50 p-2 rounded border">
                <p className="font-medium mb-1">Для настройки почтового ящика используйте формат:</p>
                <ul className="list-disc list-inside space-y-0.5 ml-2">
                  <li><code className="text-xs">email_account@example.com_password</code> - пароль</li>
                  <li><code className="text-xs">email_account@example.com_imap_host</code> - IMAP сервер</li>
                  <li><code className="text-xs">email_account@example.com_smtp_host</code> - SMTP сервер</li>
                  <li><code className="text-xs">email_account@example.com_imap_port</code> - IMAP порт (обычно 993)</li>
                  <li><code className="text-xs">email_account@example.com_smtp_port</code> - SMTP порт (обычно 587)</li>
                </ul>
                <p className="mt-1 text-xs">Или общие настройки: <code className="text-xs">email_password</code>, <code className="text-xs">imap_host</code>, <code className="text-xs">smtp_host</code></p>
              </div>
